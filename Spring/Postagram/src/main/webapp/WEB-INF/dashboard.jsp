...
<body style="background: linear-gradient(45deg, #f6f3f3, #ebedee);">
    ...
    <main role="main ">
        <section class="container d-flex" style="margin-top: 90px;">
            <div style="background-color: grey; width:25%;">
            </div>
            <div style="width:45%; height:100vh;">
                <div
                    style="background-color: white; width:90%; height:35vh; border-radius: 10px 10px; margin: 0 auto;">
                    <div class="d-flex">
                    ...
                    <c:forEach items='${ allUsers }' var='user'>
                        <c:forEach items='${ user.pics }' var='pic'>
                            <div class="mt-5 m-auto"
                                ...
                                <div class="div d-flex">
                                    ...
                                    <a href="/user/profile/${user.id}" class="text-dark"
                                ...
                                <div class="d-flex m-2">
                                    <form:form action="/post/like/${pic.id}" method="post" modelAttribute="newLike">
                                    </form:form>
                                ...
                                <div class="d-flex">
                                    <p style="font-family:Nunito, sans-serif; font-size:1rem; margin-left:20px; font-weight:800; display:contents">${user.userName}</p>
                                    <p class="ms-1 float-left" style="font-family:Nunito, sans-serif; font-size:1rem; display:contents">${pic.description}</p>
                                </div>
                            </div>
                            <script>
            ...
            <div style="background-color: grey; width:25%; height:100vh">
